...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Lineas de idioma para validacion (Espanol)
    |--------------------------------------------------------------------------
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Lineas de idioma personalizadas
    |--------------------------------------------------------------------------
    */
 
    'custom' => [
        'g-recaptcha-response' => [
            'required' => 'Por favor confirma que no eres un robot.',
        ],
    ],
 
    /*
    |--------------------------------------------------------------------------
    | Nombres de atributos en espanol
    |--------------------------------------------------------------------------
    */
